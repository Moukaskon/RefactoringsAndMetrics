...
REFACTORINGS = [
    "EXTRACT_SUPERCLASS", "EXTRACT_INTERFACE", "EXTRACT_CLASS","MOVE_AND_RENAME_OPERATION",
    "MOVE_AND_RENAME_OPERATION","SPLIT_CLASS", "EXTRACT_OPERATION", "MOVE_OPERATION",
    "PULL_UP_OPERATION", "EXTRACT_AND_MOVE_OPERATION"
]

# Directory containing the CSV files
PROJECT_DIR = r"C:\Users\Kalo\Desktop\NewRefs\RefactoringsAndMetrics\CSVs"
